try{
    $(function() {
        ...
        $('.validate li label span').hide();
        /* Required message */
        var requiredMsg = "Preenchimento obrigat\u00f3rio!";
        /* E-mail message */
        var mailMsg = "O e-mail informado n\u00e3o \u00e9 v\u00e1lido!";
        /* CPF message */
        var cpfMsg = "CPF informado inv\u00e1lido!";
        /* cnpj message */
        var cnpjMsg = "CNPJ informado inv\u00e1lido!";
        /* Data message */
        var dataMsg = "Data informada inv\u00e1lida!";    
        /* Numeric message */
        var numericMsg = "O valor deve ser num\u00e9rico!";
        /* minlength message */
        var minMsg = "Informe ao menos X caracters!";
        /* maxlength message */
        var maxMsg = "A quantidade m\u00e1xima Ž de X caracters!";
        /* Password message */
        var passwordMsg = "Senhas n‹o conferem!";
        /* Telefone message */
        var foneMsg = "O telefone informado Ž inv\u00e1lido!";    
    
    
        /* mascaras */
        $('head').append('<script src="/sctd/js/valida/js/jquery.mask.js" type="text/javascript"></script>');
        /* mascara data */
        ...
        $('head').append('<link href="/sctd/js/valida/css/button.css" type="text/css" media="screen" rel="stylesheet" />');
