...
$(function() {
    ...
    /* Required message */
    var requiredMsg = "Preenchimento obrigat—rio!";
    /* E-mail message */
    var mailMsg = "O e-mail informado n‹o Ž v‡lido!";
    /* CPF message */
    ...
    /* maxlength message */
    var maxMsg = "A quantidade m‡xima Ž de X caracters!";
    /* Password message */
    var passwordMsg = "Senhas n‹o conferem!";
    /* Telefone message */
    var foneMsg = "O telefone informado Ž inv‡lido!";    
    ...
    $(".moeda").maskMoney({symbol:"R$",decimal:",",thousands:".", symbolStay: false})
