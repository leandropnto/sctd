...
<section id="content" class="row">
    <section class="featured">
        <section class="breadcrumb">
            ...
            <span class="children">Edição de Pessoa Jurídica</span>
        </section>
        <section class="text-box">
            ...
            <div id="stylized" class="myform">
                <form action="<c:url value="/cadastros/pessoajuridica/atualizar"/>" method="post" id="form" name="form" class="validate">


                    <fieldset class="formato1">
                        <legend>Edição de Pessoa Jurídica</legend>
                        <ul>
                            <li>
                    ...
                    <div>
                        ...
                        <table id="mytable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="text-align: right; width: 15px;">${pessoa.endereco.id}</td>
