...
<script>
    $(function() {
        ...
        $('#btnCadEndereco').click(function(){
            ...
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.logradouro',
                value: $('#edLogradouro').val(),
                id: 'altEnderecoLogradouro'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.numero',
                value: $('#edNumero').val(),
                id: 'altEnderecoNumero'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.complemento',
                value: $('#edComplemento').val(),
                id: 'altEnderecoComplemento'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.bairro',
                value: $('#edBairro').val(),
                id: 'altEnderecoBairro'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.cidade',
                value: $('#edCidade').val(),
                id: 'altEnderecoCidade'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.estado',
                value: $('#edEstado').val(),
                id: 'altEnderecoEstado'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.referencia',
                value: $('#edReferencia').val(),
                id: 'altEnderecoReferencia'
            }).appendTo('#form');
            $('<input>').attr({
                type: 'hidden',                    
                name: 'pedido.cliente.endereco.cep',
                value: $('#edCep').val(),
                id: 'altEnderecoCep'
            }).appendTo('#form');
        });
    ...
    <section class="featured">
        <section class="breadcrumb">
            <span class="parents">
                ...
                <a href="<c:url value="/pedidos/pedido"/>">Registro de Pedido</a> >                 
            </span>
            <span class="children">Registro de Pedidos</span>
        </section>
        <section class="text-box">
            ...
            <div id="stylized" class="myform">
                <form action="<c:url value="/pedidos/pedido/registrar"/>" method="post" id="form" name="form" class="validate">                   
                    <fieldset class="formato1">
                        <legend>Registro de Pedido</legend>
                        <ul>
                            <li>
                                <label style="width: 150px;">Funcionario<br/>
                                    <select name="pedido.funcionario.matricula" class="required">
                                ...
                                <label style="width: 150px;">Data do Pedido<br/>
                                    <input type="text" name="pedido.dataPedido" value='<fmt:formatDate value="${data}" type="both" pattern="dd/MM/yyyy" />' readonly/>
                                    <span>Informe a data</span>
                                </label>        
                                <label style="width: 150px;">Total do Pedido<br/>
                                    <input type="text" name="pedido.precoTotal" value="0" readonly style="text-align: right"/>                                   
                                </label> 
                            </li>
                            <li>
                                <label>Forma de Pagamento<br/>
                                    <select name="pedido.fatura.forma" class="required" id="selFormaPagamento">
                            ...
                            <li>
                                <fieldset>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <input type="hidden" name="pedido.cliente.id" value="" id="clienteID"/> 
                                        </li>
        ...
        <ul>
            <li>
                <label style="width: 270px">Logradouro<br/>                                                                                        
                    <input type="text" name="pedido.cliente.endereco.logradouro" value="${pedido.cliente.endereco.logradouro}" style="width: 250px;"
                           class="required " id="edLogradouro"/> 
                    <span>Informe o Logradouro</span>
                </label>
                <label>Número<br/>
                    <input type="text" name="pedido.cliente.endereco.numero" value="${pedido.cliente.endereco.numero}" style="width: 50px;"
            ...
            <li>
                <label style="width: 270px">Complemento<br/>
                    <input type="text" name="pedido.cliente.endereco.complemento" value="${pedido.cliente.endereco.complemento}" style="width: 250px;"
                           id="edComplemento"/> 
                    <span>Informe o Complemento</span>
                </label> 
                <label>CEP<br/>
                    <input type="text" name="pedido.cliente.endereco.cep" value="${pedido.cliente.endereco.cep}" style="width: 50px;"
                           class="required numeric"  id="edCep"/> 
                    <span>Informe o CEP</span>
                </label> 
                <label>Bairro<br/>
                    <input type="text" name="pedido.cliente.endereco.bairro" value="${pedido.cliente.endereco.bairro}" style="width: 150px;"
                           class="required"  id="edBairro"/> 
                    <span>Informe o Bairro</span>
                </label> 
                <label>Cidade<br/>
                    <input type="text" name="pedido.cliente.endereco.cidade" value="${pedido.cliente.endereco.cidade}" style="width: 150px;"
            ...
            <li>
                <label>Estado<br/>
                    <select name="pedido.cliente.endereco.estado" class="required" id="edEstado"> 
                ...
                <label style="320px;">Referência<br/>
                    <input type="text" name="pedido.cliente.endereco.referencia" value="${pedido.cliente.endereco.referencia}" style="width: 300px;"
