<section id="content" class="row">
    <section class="featured">
        <section class="breadcrumb">
            ...
            <span class="children">Inclusão de Pessoa Física</span>
        </section>
        <section class="text-box">
            ...
            <div id="stylized" class="myform">
                <form action="<c:url value="/cadastros/pessoafisica/salvar"/>" method="post" id="form" name="form" class="validate">


                    <fieldset class="formato1">
                        <legend>Inclusão de Pessoa Física</legend>
                        <ul>
                            <li>
