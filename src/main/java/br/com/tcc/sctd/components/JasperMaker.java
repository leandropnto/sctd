...
public class JasperMaker {
     ...
     *
     * @param jasperFile o nome do arquivo .jasper, o diretório onde o .jasper
     * deve estar é definido no properties através do parametro "jasper.dir".
     * @param dataSource a coleção de beans a ser usada no reporter.
     * @param fileName o nome do arquivo a ser gerado.
     * @param doDownload se o arquivo é para download, em caso de <tt>false</tt>
     * o arquivo poderá ser aberto no proprio browser.
     ...
     * parametros são injetados por este método o "jasperPath" contendo o
     * caminho para a paste dos arquivos jasper e o "contextPath" contendo o
     * caminho para a raiz do aplicativo web.
     * @return um {@link Download} a ser enviado como retorno.
     */
